...
namespace TravelCompanyDatabaseImplement
{
    public class TravelCompanyDatabase : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=Tamara-PC\SQLEXPRESS;Initial Catalog=TravelCompanyDatabaseComplic;Integrated Security=True;MultipleActiveResultSets=True;");
            }
